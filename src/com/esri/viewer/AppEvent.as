...
public class AppEvent extends Event
{
	 ...
	 * InfoAlameda Events.
	 */
	public static const All_CLOSE:String				=	"closeAll";
	public static const DATA_UPDATED:String				=	"updateData";
	public static const LEGEND_CHANGED:String			=	"changeLegend";
	public static const ADD_CHART:String				=	"addChart";
	//--------------------------------------------------------------------------
    //
    //  Constructor
    //
