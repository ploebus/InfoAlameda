...
public class WidgetTemplate extends SkinnableContainer implements IWidgetTemplate
{
    ...
    public function WidgetTemplate()
    {
        ...
        this.width = 300;
        this.height = 300;
		//AppEvent.addListener(AppEvent.All_CLOSE,closeMe);
	...
	private function closeMe(E:AppEvent):void{
		AppEvent.removeListener(AppEvent.All_CLOSE,closeMe);
		if(_widgetTitle!= 'Identify Tool'){
			//Alert.show(_widgetTitle);
			if (_baseWidget)
				{
