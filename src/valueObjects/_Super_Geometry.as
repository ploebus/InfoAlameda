 ...
 * of this value object you may modify the generated sub-class of this class - Geometry.as.
 */
...
[ExcludeClass]
public class _Super_Geometry extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _GeometryEntityMetadata;
    ...
    public function _Super_Geometry()
    {
        _model = new _GeometryEntityMetadata(this);
    ...
    model_internal function setterListenerCoordinates(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerCoordinates);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _GeometryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _GeometryEntityMetadata) : void
    {
        var oldValue : _GeometryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfCoordinates : ArrayCollection;
