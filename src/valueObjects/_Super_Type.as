 ...
 * of this value object you may modify the generated sub-class of this class - Type.as.
 */
...
[ExcludeClass]
public class _Super_Type extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _TypeEntityMetadata;
    ...
    private var _internal_fields : valueObjects.Fields;
    ...
    public function _Super_Type()
    {
        _model = new _TypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get fields() : valueObjects.Fields
    {
    ...
    public function set fields(value:valueObjects.Fields) : void
    {
        var oldValue:valueObjects.Fields = _internal_fields;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TypeEntityMetadata) : void
    {
        var oldValue : _TypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfFields : valueObjects.Fields;

    model_internal function _doValidationForFields(valueIn:Object):Array
    {
        var value : valueObjects.Fields = valueIn as valueObjects.Fields;
